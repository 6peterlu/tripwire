/*
  ...
  - The values [UPDATE_USER_STATUS] on the enum `GenericRuleActionType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GenericRuleActionType_new" AS ENUM ('UPDATE_USER_ATTRIBUTE');
