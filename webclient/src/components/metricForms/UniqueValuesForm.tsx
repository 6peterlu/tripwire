...
export default function UniqueValuesForm({
  metricCreationState,
  ...
  return (
    <div>
      ...
      />
      <Input
        placeholder="field to count"
        value={
          (metricCreationState.metricDefinition as UniqueValuesMetric)
            .transformFunction.arguments[0] as string
        }
        onChange={(e) => updateFieldInState(e.target.value)}
        label="field to count"
      />
    </div>
  );
}
